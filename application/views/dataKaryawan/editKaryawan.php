...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<?php echo base_url('assets/plugins/daterangepicker/daterangepicker.css') ?>"
    />
    ...
    <link
      rel="stylesheet"
      href="<?php echo base_url('assets/plugins/bs-stepper/css/bs-stepper.min.css') ?>"
    />
    <!-- dropzonejs -->
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card card-default">
              ...
              <!-- /.card-header -->
              <form action="<?php echo base_url(). 'DataKaryawan/editKaryawan' ?>" method="post">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Karyawan</label>
                        <input type="hidden" name="idKaryawan" class="form-control" value="<?= $karyawan->id_karyawan; ?>">
                        <input type="text" name="namaKaryawan" class="form-control" value="<?= $karyawan->nama; ?>">
                        <?php echo form_error('namaKaryawan', '<small class="text-danger pb-2">', '</small>'); ?>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Alamat</label>
                        <input type="text" name="alamat" class="form-control" value="<?= $karyawan->alamat; ?>">
                        <?php echo form_error('alamat', '<small class="text-danger pb-2">', '</small>'); ?>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php echo form_error('nik', '<small class="text-danger pb-2">', '</small>'); ?>
                      </div>
                      <div class="form-group">
                        <label>Status</label>
                         <div class="select2-purple">
                          ...
                          >
                            <option <?php if("Active"==$karyawan->status) 
                            echo 'selected="selected"'; ?>>Active</option>
                            <option <?php if("Resign"==$karyawan->status) 
                            echo 'selected="selected"'; ?>>Resign</option>
                          </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="select2-purple">
                          ...
                          <?php foreach ($getJabatan as $jbtn) : ?>
                            <option value="<?= $jbtn->id_jabatan; ?>" <?php if($jbtn->id_jabatan==$karyawan->jabatan)
                            echo 'selected="selected"'; ?>><?= $jbtn->nama_jabatan; ?></option>
                          <?php endforeach; ?>
                          </select>
                 ...
                 <button type="submit" class="btn float-right btn-block bg-gradient-primary btn-sm mt-3" style="width: 150px;">Submit</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
