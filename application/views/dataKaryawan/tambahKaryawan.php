        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card card-default">
              ...
              <!-- /.card-header -->
              <form action="<?php echo base_url(). 'DataKaryawan/tambahKaryawan' ?>" method="post">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Karyawan</label>
                        <input type="text" name="namaKaryawan" class="form-control" id="exampleInputEmail1" placeholder="Nama Karyawan">
